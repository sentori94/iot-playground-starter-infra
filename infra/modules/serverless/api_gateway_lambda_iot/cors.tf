...
# ===========================
# OPTIONS /api/runs/interrupt-all
# ===========================

resource "aws_api_gateway_method" "runs_interrupt_all_options" {
  rest_api_id   = aws_api_gateway_rest_api.lambda_iot.id
...
resource "aws_api_gateway_integration" "runs_interrupt_all_options" {
  rest_api_id = aws_api_gateway_rest_api.lambda_iot.id
  resource_id = aws_api_gateway_resource.runs_interrupt_all.id
  http_method = aws_api_gateway_method.runs_interrupt_all_options.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "runs_interrupt_all_options" {
  rest_api_id = aws_api_gateway_rest_api.lambda_iot.id
  resource_id = aws_api_gateway_resource.runs_interrupt_all.id
  http_method = aws_api_gateway_method.runs_interrupt_all_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "runs_interrupt_all_options" {
  rest_api_id = aws_api_gateway_rest_api.lambda_iot.id
  resource_id = aws_api_gateway_resource.runs_interrupt_all.id
  http_method = aws_api_gateway_method.runs_interrupt_all_options.http_method
  status_code = "200"
